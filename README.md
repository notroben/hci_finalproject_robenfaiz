...
### Running Locally
To launch the app in your local emulator (it will automatically fall back to **offline mock mode** if Firebase is not linked yet):

1. Clone this repository:
   ```bash
   git clone https://github.com/notroben/hci_finalproject_robenfaiz.git
   ```
2. Navigate to the project directory:
   ```bash
   cd hci_finalproject_robenfaiz
   ```
...
3. Configure settings:
   ...
   ```
4. Select your Firebase project and select `android` and `ios` platforms.
5. Once `lib/firebase_options.dart` is generated, import it and apply it inside `lib/main.dart` in the `Firebase.initializeApp` block.
